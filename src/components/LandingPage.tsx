    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-white/10">
      ...
      <section className="pt-32 pb-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="aurora absolute -inset-[15%] opacity-60" />
          <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-brand/20 blur-[120px] rounded-full" />
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          >
            <Badge variant="secondary" className="px-4 py-1.5 rounded-full bg-brand/10 border-brand/20 text-white/80 gap-2 mb-6">
              <Sparkles className="w-3.5 h-3.5" />
              Revolutionizing Video Content with AI
            </Badge>
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1] [text-shadow:0_2px_30px_rgba(0,0,0,0.5)]">
          ...
          <motion.div
            ...
            className="max-w-xl mx-auto flex flex-col sm:flex-row gap-3 items-center justify-center p-2 rounded-2xl bg-white/5 border border-brand/20 backdrop-blur-sm"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 mt-12">
        <div className="flex gap-4 overflow-x-auto pb-8 no-scrollbar">
          {[
            ...
            <div key={i} className="flex-shrink-0 w-48 aspect-[9/16] rounded-2xl bg-white/5 border border-white/10 relative overflow-hidden group transition-all duration-300 group-hover:border-brand/40 group-hover:-translate-y-1">
              <div className={cn("absolute inset-0 opacity-30 group-hover:opacity-70 transition-opacity", cat.color)} />
              <div className="absolute inset-0 flex flex-col justify-end p-4">
                <span className="text-xs font-bold uppercase tracking-widest">{cat.label}</span>
                <div className="h-1 w-0 group-hover:w-full bg-gradient-to-r from-brand to-brand-2 transition-all duration-300 mt-2" />
              </div>
        ...
        >
          ...
          <div className="rounded-2xl border border-brand/20 overflow-hidden shadow-2xl shadow-brand/10 bg-[#0a0a0a]">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="space-y-4 p-6 rounded-2xl bg-white/[0.02] border border-white/5 transition-colors hover:border-brand/20">
      ...
      <section id="how-it-works" className="py-24 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-20 space-y-4">
          <Badge variant="secondary" className="px-4 py-1 rounded-full bg-brand/10 border-brand/20 text-white/80">Process</Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <div key={i} className="relative space-y-4 group">
              <div className="text-6xl font-black text-white/[0.03] absolute -top-10 -left-4 group-hover:text-brand/20 transition-colors">{s.step}</div>
              ...
              <div className="h-1 w-12 bg-white/10 rounded-full group-hover:w-full group-hover:bg-gradient-to-r group-hover:from-brand group-hover:to-brand-2 transition-all duration-500" />
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <Card key={i} className="bg-white/[0.02] border-white/5 hover:border-brand/30 transition-colors group">
              <CardContent className="pt-6">
                <div className="mb-4 p-2 w-fit rounded-lg bg-white/5 group-hover:bg-brand/10 group-hover:scale-110 transition-all">
                  {feature.icon}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <Card key={i} className={cn(
              ...
              plan.popular && "border-brand/40 bg-brand/5 scale-105 z-10"
            )}>
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-3 py-1 bg-gradient-to-r from-brand to-brand-2 text-white text-[10px] font-bold rounded-full">
                  MOST POPULAR
                </div>
              )}
              <CardHeader>
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto glass border border-white/10 rounded-[2rem] p-12 text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-brand/10 blur-3xl -z-10" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" onClick={onGetStarted} className="rounded-full px-8 border-white/10 hover:bg-brand/10 hover:border-brand/30">
              Watch Demo
            </Button>
          </div>
        </div>
